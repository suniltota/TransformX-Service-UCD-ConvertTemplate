...
public class FeeEnum {
    ...
    @XmlValue
    protected FeeBase value;
    @XmlAttribute(name = "DisplayLabelText", namespace = "http://www.datamodelextension.org")
    protected String displayLabelText;

    /**
     * Term: Fee Type Definition: Specifies the general type of fees associated with a real estate finance transaction.
     * 
     * @return
     *     possible object is
     *     {@link String }
     ...
     *     
     */
    public void setValue(FeeBase value) {
        this.value = value;
    }
