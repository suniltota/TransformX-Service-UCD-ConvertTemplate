...
/**
 * <p>Java class for IntegratedDisclosureSection.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="IntegratedDisclosureSection">
 *   &lt;restriction base="{http://www.datamodelextension.org}Enum_Base">
 ...
 * 
 */
@XmlType(name = "IntegratedDisclosureSection")
@XmlEnum
public enum IntegratedDisclosureSection {
    ...
    IntegratedDisclosureSection(String v) {
        value = v;
    }
    ...
    public static IntegratedDisclosureSection fromValue(String v) {
        for (IntegratedDisclosureSection c: IntegratedDisclosureSection.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
